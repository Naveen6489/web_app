  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-primary:hover {
      ...
      transform: translateY(-2px); box-shadow: 0 8px 24px rgba(224, 122, 95, 0.30);
    }
    .btn-ghost {
    ...
    .header-inner {
      ...
      gap: 16px; padding: 12px 0; min-height: 68px;
    }
    .brand {
    ...
    .search-wrap {
      ...
      padding: 0 16px 0 18px; transition: var(--transition);
    ...
    .search-wrap input {
      ...
      width: 100%; padding: 10px 0; font-size: 14px; color: var(--primary);
    }
    .search-wrap input::placeholder { color: var(--muted-light); }
    .search-wrap button {
      padding: 8px 0 8px 10px; color: var(--muted);
    ...
    .product-card .wish-btn:hover {
      background: #fff; color: var(--accent); transform: scale(1.10);
    }
    .product-card .body {
    ...
    .deal-wrap .deal-content .price-big .old {
      ...
      color: var(--muted-light); text-decoration: line-through; margin-left: 10px;
    }
    ...
    .newsletter-wrap form .btn {
      background: var(--accent); color: #fff;
      border-color: var(--accent); padding: 14px 32px;
    }
    .newsletter-wrap form .btn:hover {
      background: var(--accent-dark); border-color: var(--accent-dark);
    }
    #newsletterMsg {
      margin-top: 12px; font-size: 14px; opacity: 0.9; width: 100%;
    }
    ...
    <section class="section" id="categories" aria-labelledby="cat-title">
      <div class="container">
        <div class="section-header">
          ...
          <a href="#" class="view-all">All Categories <i class="fas fa-arrow-right"></
